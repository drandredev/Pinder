            ...
            <div class="card" style="height:auto">
                ...
                <div class="card-body"s>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right" style="color:white">{{ __('Direccion de Correo') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="telef" class="col-md-4 col-form-label text-md-right" style="color:white">{{ __('Telefono') }}</label>

                            <div class="col-md-6">
                                <input id="telef" type="number" class="form-control @error('telef') is-invalid @enderror" name="telef" value="{{ old('telef') }}" required autocomplete="telef" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn" style="background-color:#FC5AA6; color:white;">
                                    {{ __('Registrarse') }}
                                </button>
                            </div>
                        </div>
